...
port = 3306
user = 'root'
password = 'Password1659'
conn = pymysql.connect(host=host, port=port, user=user, password=password)
cursor = conn.cursor()
cursor.execute("USE youtube_warehouse")
...
with col1:
    st.markdown("<h3 style='text-align: left; color: rgb(46, 184, 184);'>Store YouTube Channel Data</h3>", unsafe_allow_html=True)
...
with col2:
    st.markdown("<h3 style='text-align: left;color:rgb(46, 184, 184);'>YouTube Channels in MongoDB</h3>", unsafe_allow_html=True)
    ...
    for index, value in enumerate(m_c_list, start=1):
        ...
        channels_mongodb.append(f"<span style='color:rgb(37, 142, 142);font-weight: bold;'>{channel}</span>")
    data='<br>'.join(channels_mongodb)
    st.markdown(f"<div style='{style}'>{data}</div>", unsafe_allow_html=True)

# display mysql database
with col3:
    st.markdown("<h3 style='text-align: left;color:rgb(46, 184, 184);'>YouTube Channels in Mysql</h3>", unsafe_allow_html=True)
...
#------------------------------------------------Database operations--------------------------------------
st.markdown("---")
st.markdown("<h2 style='text-align: center; color:rgb(172, 57, 172);'>Database Operations</h2>", unsafe_allow_html=True)
st.markdown("---")
...
with colum1:
    st.markdown("<h3 style='text-align: left; color:rgb(198, 83, 198);'>Migrate from MongoDB to MySQL</h3>", unsafe_allow_html=True)
...
with colum2:
    st.markdown("<h3 style='text-align: left;color:rgb(198, 83, 198);'>Delete or Overview Channels</h3>", unsafe_allow_html=True)
...
with colum3:
    if submitted:
        st.markdown("<h3 style='text-align: left; color:rgb(198, 83, 198);'>DB Operation Results</h3>", unsafe_allow_html=True)
        if input_ch:
        ...
        st.markdown("<h3 style='text-align: left; color:rgb(198, 83, 198)'>Database Operation Result will appear here</h3>", unsafe_allow_html=True)

#-------------------------------------------------SQL Queries--------------------------------------------

st.markdown("---")
st.markdown("<h2 style='text-align: center; color:rgb(255, 92, 51);'>SQL Quries</h2>", unsafe_allow_html=True)
st.markdown("---")
max_height = 700
style = f"max-height: {max_height}px; overflow-y: auto;"
...
with c1:
    st.markdown("<h3 style='text-align: center; color:rgb(255, 92, 51);'>SQL Queries Available</h3>", unsafe_allow_html=True)
...
with c2:
    if not button1 and not button2 and not button3 and not button4 and not button5 and not button6 and not button7 and not button8 and not button9 and not button10:
        st.markdown("<h3 style='text-align: center;color:rgb(255, 92, 51);'>SQL Queries Output will appear below</h3>", unsafe_allow_html=True)
    if button1:
